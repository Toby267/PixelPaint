...
public class PCanvas extends JPanel {
     ...
     * to be rendered onto the screen, also responsible for handling the pan and
     * zooming
    ...
    public Point2D getPixelPoint(Point p) {
        ...
        try {
            ...
            // to 0
            // this should not be possible due to limits being enforced when controlling the
            // zoom
